...
/*====================================================
  ...
  on an Arduino Nano in order to callibrate the IMU.
  ====================================================*/
...
void setup()
{
    ...
    delay(2000);
    Serial.println("Your MPU6050 should be placed in horizontal position, with package letters facing up. Don't touch it until you see a finish message.");
    delay(3000);
    // verify connection
